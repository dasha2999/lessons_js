...
// 2.1 отфильтровать авто так чтобы в результирующий массив вошли только машины из региона Гомель.
...
//             }
//         },
//         region: ['New York', 'Berlin', 'Barcelona']
//     },
//     specs: {
//         price: {
//             low: 100000,
...
// const arr = arrCars.filter((carItem) => {
//     return carItem.adress.region.includes('Gomel')
// })
...
// const totalMaxPrice = arrCars.reduce((acc,currentCar)=> {
//     return acc += currentCar?.specs?.price?.higher
// }, 0)

// console.log(totalMaxPrice)
